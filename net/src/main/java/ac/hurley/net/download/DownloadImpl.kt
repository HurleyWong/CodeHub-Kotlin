...
import ac.hurley.net.base.ServiceManager
import ac.hurley.net.service.DownloadService
...
object DownloadImpl {
    ...
    suspend fun download(url: String, build: IDownloadBuild) = flow {
        val response = ServiceManager.create(DownloadService::class.java).downloadFile(url)
